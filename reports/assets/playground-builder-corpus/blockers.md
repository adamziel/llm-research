...
## GitHub Pages endpoint (checked 2026-08-11)

The GitHub Pages report is live at:

`https://adamziel.github.io/llm-research/reports/playground-builder-corpus.html`

Reproduction from any shell:

```sh
curl -L --fail https://adamziel.github.io/llm-research/reports/playground-builder-corpus.html
# HTTP 200; response includes wpbakery-wxr-pressroom
curl -L --fail https://adamziel.github.io/llm-research/reports/assets/playground-builder-corpus/wpbakery-wxr-pressroom/post-content.json
# HTTP 200; JSON contains 21 rows
```

GitHub's unauthenticated Pages API endpoint still responds with HTTP 404, so it is not a reliable configuration check for this repository. The public report and its published assets are the checked deployment surface.
